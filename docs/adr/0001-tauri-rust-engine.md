...
implementation: Tauri gives a ~6.5 MB portable exe (vs ~63 MB self-contained .NET) and keeps the
heavy window logic in Rust where the Win32 surface is small and testable.
